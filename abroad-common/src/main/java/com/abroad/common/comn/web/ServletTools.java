...
public class ServletTools {
	...
	/**
	* @Title: isAjaxRequest
	* @Description: TODO(判定是否为Ajax请求)
	* @param @return    设定文件
	* @return boolean    返回类型
	* @author: mengxr
	* @date 2017年4月18日 下午5:28:24
	* @throws
	*/
	public static boolean isAjaxRequest(){
		String requestType = ServletTools.getRequest().getHeader("x-requested-with"); 
		return null != requestType ? true : false;
	}
	/**
