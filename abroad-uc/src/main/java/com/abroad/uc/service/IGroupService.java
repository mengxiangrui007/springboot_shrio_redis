...
public interface IGroupService {
	...
	* @throws
	*/
	boolean insertGroup(GroupVO group) throws Exception;
	...
	* @throws
	*/
	Group queryGroup(Long id) throws Exception;
	/**
	...
	* @author: mengxr
	* @date 2017年4月19日 上午11:57:59
	* @throws
	*/
	List<Group> queryGroupChildren() throws ServiceException;
	void test(List<CountryRegionTest> countryRegionTests)  throws ServiceException;
}
